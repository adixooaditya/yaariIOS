...
extension UIViewController {
    ...
    func pricefliterList(priceFilterArray:[Int],collectsionId: String) -> AnyObject{
        
        
    
        let getcollecstionId = Int(collectsionId)
        ...
        let dict = ["where":
                        ["and":
                            [
                                ["collectionId": getcollecstionId!,
                                 "productStatus":"approved",
                                 "status":"active",
                                 ],
                                ["sellingPrice":
                                   [
                                "between":priceFilterArray]]
        ...
        do {
            ...
            jsonstring = String(data: jsonData, encoding: .utf8)! as AnyObject
    ...
    func categoryfliterList(categoryId:String,selectValueArray:[Int]) -> AnyObject{
        
//        let filtercategoryId = selectValueArray.joined(separator: ",")
//
//        let getfilterCategoryId = Int(filtercategoryId)
    ...
    func fliter(collectsionId:String) -> AnyObject{
    ...
    func fliterSubCategory(subCategoryId:String) -> AnyObject{
        
        var jsonstring:AnyObject!
        let getsubCategoryId = Int(subCategoryId)
